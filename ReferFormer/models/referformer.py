...
class ReferFormer(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels, 
        ...
        text_preained_path = '/mnt/data_16TB/lzy23/pretrained/pretrained_roberta'
        self.tokenizer = RobertaTokenizerFast.from_pretrained(text_preained_path)
        self.text_encoder = RobertaModel.from_pretrained(text_preained_path)
