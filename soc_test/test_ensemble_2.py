...
def ensemble(args):
    ...
    # path_vit_h = os.path.join("vit-huge", "Annotations_AOT_class_index") # 73.4
    path_0 = os.path.join("vit_convnext_soc", "Annotations_DEAOT_class_index")
    # path_0 = os.path.join("socft_mutr_referft", "Annotations_DEAOT_class_index")
    # path_0 = os.path.join("soc_mutr_referft", "Annotations_DEAOTALL_class_index")
    # path_swap = os.path.join("soc_ensemble_3", 'Annotations_AOT_class_index') #71.3
    path_1 = os.path.join("vit-huge", "Annotations_DEAOT_class_index")
    # path_1 = os.path.join("soc_ft", "Annotations_DEAOT_class_index")
    # path_1 = os.path.join("soc", "Annotations_DEAOTALL_class_index")
    # path_soc = os.path.join('soc_aot_1', 'Annotations_AOT_class_index') #69.7
    # path_mutr = os.path.join('mutr', 'Annotations_AOT_class_index')
    # path_2 = os.path.join("mutr", "Annotations_DEAOT_class_index")
    # path_2 = os.path.join("convnext","Annotations_DEAOT_class_index")
    # path_2 = os.path.join("second_ensemble", "Annotations_soc_mutr_referft_aot_socaot_mutraot_referftaot")
    # path_2 = os.path.join("second_ensemble_2", "Annotations_socft_mutr_referft_deaot_socftdeaot_mutrdeaot_referftdeaot")
    path_2 = os.path.join("second_ensemble", "Annotations_en2")
    # path_3 = os.path.join("soc_aot_1", "Annotations_DEAOT_class_index")
    path_3 = os.path.join("referformer_ft", "Annotations_DEAOT_class_index")
