...
class DefaultEngineConfig():
    ...
    def init_dir(self):
        ...
        self.DIR_ROOT = '/mnt/Models/rvos/aot/'
        ...
        # self.DIR_YTB_POST_EVAL = '/mnt/Models/rvos/postprocess/video_swin_base_with_clip_seg_scratch/'
        # self.PICKED_KEY_FRAMES_ID = '/mnt/Models/rvos/postprocess/video_swin_base_with_clip_seg_scratch/vsb_with_cs.json'
