...
def parse_args():
    ...
    parser.add_argument("--src_path", default="/mnt/data_16TB/lzy23/MTTR/uninet/model_final.pth", type=str, help="")
    parser.add_argument("--des_path", default="/mnt/data_16TB/lzy23/MTTR/uninet/model_final_4c.pth", type=str, help="")
