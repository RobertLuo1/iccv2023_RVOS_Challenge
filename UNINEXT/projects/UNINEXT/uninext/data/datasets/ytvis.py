...
def register_ytvis_instances(name, metadata, json_file, image_root, has_mask=True, has_expression=False, sot=False):
    ...
    image_root = "/mnt/data_16TB/lzy23/rvosdata/refer_youtube_vos/test/JPEGImages"
    json_file = "/mnt/data_16TB/lzy23/rvosdata/refer_youtube_vos/test.json"
